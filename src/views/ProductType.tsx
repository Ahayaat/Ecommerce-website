...
const ProductType = () => {
  return (
    <div className="py-16 px-10 space-y-5">
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 text-gray-800 max-auto">
        {/* first grid */}
        <div className="w-full flex  flex-col item-center justify-between sm:flex-row col-span-1 md:col-span-2 bg-[#D6D6D8] px-12 ">
